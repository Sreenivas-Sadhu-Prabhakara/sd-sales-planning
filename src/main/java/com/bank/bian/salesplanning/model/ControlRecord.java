package com.bank.bian.salesplanning.model;
...
/**
 * The BIAN control record for this service domain: "Sales Plan Plan".
 *
 ...
 * to its asset type (Sales Plan). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Sales Plan Plan";
